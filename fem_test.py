...
#    obj.set_solve_method('iterative')
    ...
    obj.add_surface_load('1.0e+4*cos(atan2(z,x))', '(y <= 0 and y>=-0.2690) and (abs(x^2 + z^2 - (1.037-0.0015)^2) <= eps)', DIR_X)
    obj.add_surface_load('1.0e+4*sin(atan2(z,x))', '(y <= 0 and y>=-0.2690) and (abs(x^2 + z^2 - (1.037-0.0015)^2) <= eps)', DIR_Z)
    obj.add_surface_load('1.0e+4*cos(atan2(z,x))*sin(atan2((x^2+z^2)^0.5,(y + 0.2690)))', '(y < -0.2690) and (abs(x^2 + z^2 + (y + 0.2690)^2 - (1.037-0.0015)^2) <= eps)', DIR_X)
    obj.add_surface_load('1.0e+4*cos(atan2(z,x))*sin(atan2((x^2+z^2)^0.5,(y + 0.2690)))', '(y < -0.2690) and (abs(x^2 + z^2 + (y + 0.2690)^2 - (1.037-0.0015)^2) <= eps)', DIR_Y)
    obj.add_surface_load('1.0e+4*cos(atan2((x^2+z^2)^0.5,(y + 0.2690)))', '(y < -0.2690) and (abs(x^2 + z^2 + (y + 0.2690)^2 - (1.037-0.0015)^2) <= eps)', DIR_Z)
    obj.add_surface_load('1.0e+4*cos(atan2(z,x))*sin(atan2((x^2+z^2)^0.5,y))', '(y > 0) and (abs(x^2 + y^2 + z^2 - (1.037-0.0015)^2) <= eps)', DIR_X)
    obj.add_surface_load('1.0e+4*cos(atan2((x^2+z^2)^0.5,y))', '(y > 0) and (abs(x^2 + y^2 + z^2 - (1.037-0.0015)^2) <= eps)', DIR_Y)
    obj.add_surface_load('1.0e+4*sin(atan2(z,x))*sin(atan2((x^2+z^2)^0.5,y))', '(y > 0) and (abs(x^2 + y^2 + z^2 - (1.037-0.0015)^2) <= eps)', DIR_Z)
